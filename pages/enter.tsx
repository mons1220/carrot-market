      ...
      <div className="mt-8">
        ...
        <form className="flex flex-col mt-8">
          ...
          <div className="mt-1">
            ...
            className="appearance-none w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm paceholder-gray-400 
            ...
            {method === "phone" ? (
              <div className="flex rounded-md shadow-sm">
                ...
                <input type="number" className="appearance-none w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm paceholder-gray-400 
            focus:outline-none focus:ring-orange-500 focus:border-orange-500 rounded-l-none" required />
              </div>
            ) : null}
          </div>
          <button className="mt-5 bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 
