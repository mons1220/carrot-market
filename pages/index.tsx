...
const Home: NextPage = () => {
  return (
    ...
    min-h-screen xl:place-content-center">
      ...
      <div className="bg-white p-10 rounded-3xl shadow-xl lg:col-span-2 xl:col-span-1">
        ...
        <div className='flex flex-col'>
          ...
          <div className='flex justify-between items-center'>
            <span className='font-medium text-2xl'>$560</span>
            <button className='bg-blue-500 py-2 px-8 text-center text-white text-xs rounded-lg'>Add to cart</button>
          </div>
        </div>
      </div>
      ...
      <div className='bg-white p-5 rounded-3xl shadow-xl'>
        <div className='flex flex-col space-y-2 p-5'>
          <h2 className='text-[100px] text-[#cf4848] bg-[url("/vercel.svg")]'> 100px </h2>
        </div>
      </div>
